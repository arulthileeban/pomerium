...
// Returns an ASN.1-encoded Universal Principal Name extension.
func newUpnExtension(upnValue string) []byte {
	type UPN struct {
...
func main() {
	...
	trustedClientCert7PEM, _, _ := newCertificate(&x509.Certificate{
		SerialNumber: big.NewInt(0x1008),
		Subject: pkix.Name{
		...
		ExtraExtensions: []pkix.Extension{
			{
				...
				Value: newUpnExtension("test_device"),
			},
		},
	}, rootCA, rootKey)
